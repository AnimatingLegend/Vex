...
export default class VexGame {
    constructor({width = 640, height = 480, canvas = null, initialState, framerate = 60 } = {}) {
    ...
    _bindInput() {
        ...
        this.canvas.addEventListener('mousemove', (e) => VexGlobal.mouse._onMove(e, this.canvas));
    ...
    _draw() {
        ...
        if (VexGlobal.state)
            VexGlobal.state.draw(ctx, VexGlobal.camera);
